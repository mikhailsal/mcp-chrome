 ...
 *
 * The service handles session-level orchestration without depending on specific
 * CLI or SDK details. By targeting the Engine interface, the HTTP routing layer
 * can add or swap engines without changes.
 */
