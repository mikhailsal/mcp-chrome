...
function createPositionIcon(position: PositionValue): SVGElement {
  ...
  switch (position) {
    ...
    case 'relative': {
      // Dashed outline shows the original position; solid block shows the offset position
    ...
    case 'absolute':
      // Positioning guides from container edges to the element
    ...
    case 'fixed': {
      // Pushpin shape represents fixed positioning
...
function createFlipXIcon(): SVGElement {
  ...
  // Left mirrored block, semi-transparent to indicate the original
  ...
  // Right mirrored block, solid to indicate the flipped result
...
function createFlipYIcon(): SVGElement {
  ...
  // Top mirrored block, semi-transparent to indicate the original
  ...
  // Bottom mirrored block, solid to indicate the flipped result
