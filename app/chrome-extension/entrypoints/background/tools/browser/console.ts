  ...
  async execute(args: ConsoleToolParams): Promise<ToolResult> {
    ...
    try {
      ...
      if (resolvedMode === 'buffer') {
        ...
        // Handle clear-before-read requests
        ...
        // Handle clear-after-read requests (mcp-tools.js style, to avoid duplicate reads)
  ...
  private async captureConsoleMessages(
    ...
    try {
      ...
      try {
        ...
        // Do not disable the Runtime or Log domains if buffer mode is using this tab
