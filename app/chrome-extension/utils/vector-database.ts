...
export class VectorDatabase {
  ...
  private calculateStorageSize(): number {
    ...
    try {
      ...
      // Fall back to an estimate based on document count
      totalSize = this.documents.size * 1024; // Estimate 1 KB per document
    }
